<x-app-layout>
    <x-slot name="title">Search BVN Using Phone Number</x-slot>
            ...
            <div class="col-xl-6 mb-4">
                <div class="card">
                    <div class="card-header card-no-border pb-0">
                        <h3>BVN Search Form</h3>
                        <p class="mt-1 mb-0">Request for BVN search Using phone number is instant and we charge 20% on failed search</p>
                        ...
                        <form class="row g-3" method="POST" action="{{ route('phone.search.store') }}">
                            ...
                            <div class="col-12">
                                <label class="form-label">Phone Number <span class="text-danger">*</span></label>
                                 <input class="form-control" name="number" type="text" required placeholder="Enter 11 Digit Phone number" maxlength="11" minlength="11" 
